<table id="page-header" width="100%">
	<tr>
		<td><h3>LAMAN PENGURUSAN PENYERAHAN BUKU</h3></td>
		<td align="right">&nbsp;</td>
	</tr>
	<tr>
		<td>Sila pilih kelas bagi memulakan proses penyerahan buku.</td>
		<td align="right">&nbsp;</td>
	</tr>
</table>
<br />
...
foreach($yearslist as $iyearslist)
{
	...
	{
		$url = site_url('books/checkout/check/classtotal/' . $iyearslist->is_years_digit . '/' . $iclasslist->is_class_ind);
		echo "
		<tr>
