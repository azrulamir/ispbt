...
class TCPDF {
	 ...
	 * @protected
	 */
	var $starting_page_number = 1;

	/**
	 * String alias for total number of pages.
	 * @protected
	 */
	var $alias_tot_pages = '{:ptp:}';

	/**
	 * String alias for page number.
	 * @protected
	 */
	var $alias_num_page = '{:pnp:}';

	/**
	 * String alias for total number of pages in a single group.
	 * @protected
	 */
	var $alias_group_tot_pages = '{:ptg:}';

	/**
	 * String alias for group page number.
	 * @protected
	 */
	var $alias_group_num_page = '{:png:}';

	/**
	 * String alias for right shift compensation used to correctly align page numbers on the right.
	 * @protected
	 */
	var $alias_right_shift = '{rsc:';
	 ...
	 */
	var $empty_signature_appearance = array();
	 ...
	 * @since 5.9.086
	 */
	function sendOutputData($data, $length) {
	 ...
	 * @protected
	 */
	function getInternalPageNumberAliases($a= '') {
		$alias = array();
	 ...
	 * @protected
	 */
	function getAllInternalPageNumberAliases() {
	 ...
	 * @protected
	 */
	function replacePageNumAliases($page, $replace, $diff=0) {
	 ...
	 * @protected
	 */
	function replaceRightShiftPageNumAliases($page, $aliases, $diff) {
	 ...
	 * @protected
	 */
	function UTF8ToUTF16BE($str, $setbom=false) {
		if (!$this->isunicode) {
	 ...
	 * @since 5.9.097 (2011-06-23)
	 */
	function encodeNameObject($name) {
		$escname = '';
		$length = strlen($name);
		for ($i = 0; $i < $length; ++$i) {
			$chr = $name{$i};
	 ...
	 * @since 5.9.097 (2011-06-23)
	 */
	function setDestination($name, $y=-1, $page='') {
	 ...
	 * @public
	 */
	function setBookmark($txt, $level=0, $y=-1, $page='', $style='', $color=array(0,0,0)) {
	 ...
	 * @since 5.9.101 (2011-07-06)
	 */
	function addEmptySignatureAppearance($x=0, $y=0, $w=0, $h=0, $page=-1) {
		++$this->n;
	 ...
	 * @since 5.9.101 (2011-07-06)
	 */
	function getSignatureAppearanceArray($x=0, $y=0, $w=0, $h=0, $page=-1) {
		$sigapp = array();
	 ...
	 * @public
	 */
	function setStartingPageNumber($num=1) {
	 ...
	 * @since 5.9.102 (2011-07-13)
	 */
	function startLayer($name='', $print=true, $view=true) {
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 */
	function startTemplate($w=0, $h=0, $group=false) {
		if ($this->inxobj) {
